...
const Login = () => {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    if(name.length > 0 && lastname.length > 0 && email.length > 0 && password.length > 0 && confirmPassword.length > 0){
      ...
      if(password === confirmPassword){
        ...
        try{
        const response = await axios.post(`${window.location.origin}/api/v1/register`, formData);
  ...
  return (
    <div className="register-main caret-transparent">
       
      <div className="register-left">
        <img src="https://th.bing.com/th/id/OIG1.18HHd7VZFlfizIjzS600?pid=ImgGn" alt="" className="rounded-xl" />
      </div>
      <div className="register-right">
        <div className="register-right-container">
          <div className="register-logo">
            <img src="https://th.bing.com/th/id/OIG1.18HHd7VZFlfizIjzS600?pid=ImgGn" alt=""  />
          </div>
